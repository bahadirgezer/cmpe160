...
public class Market {
	...
	/**
	 * Time to wait after an add() operation to a PriorityQueue in miliseconds.
	 * Check the Market.wait() function for more details.
	 */
	private int time = 10;
	...
	public void checkTransactions(ArrayList<Trader> traders) {
		...
		while(sellingOrders.peek().getPrice() <= buyingOrders.peek().getPrice()) {
			...
			buyingMarketDollarSize -= buyingOrder.getAmount()*buyingOrder.getPrice();
	...
	protected static class Pair {
		...
		/**
		 * The BuyingOrder Constructor for the Pair class. 
		 * 
		 * @param orderTransaction The BuyingOrder object which will be used in the transaction.
		 * @param orderMarket The BuyingOrder object which will be added back to the market.
		 */
	    ...
	    /**
		 * The SellingOrder Constructor for the Pair class. 
		 * 
		 * @param orderTransaction The SellingOrder object which will be used in the transaction.
		 * @param orderMarket The SellingOrder object which will be added back to the market.
		 */
	    ...
	    /**
	     * Getter method for the BuyingOrder object which will be used in the transaction.
	     * 
	     * @return The BuyingOrder object which will be used in the transaction.
	     */
	    ...
	    /**
	     * Getter method for the BuyingOrder object which will be added back to the market.
	     * 
	     * @return The BuyingOrder object which will be added back to the market.
	     */
	    ...
	    /**
	     * Getter method for the SellingOrder object which will be used in the transaction.
	     * 
	     * @return The SellingOrder object which will be used in the transaction.
	     */
	    ...
	    /**
	     * Getter method for the SellingOrder object which will be added back to the market.
	     * 
	     * @return The SellingOrder object which will be added back to the market.
	     */
	...
	/**
	 * This method will make the program wait.<p> I used it after PriorityQueue.add()
	 * operations, because I had out of memory exceptions whenever I tried to run a 
	 * large test case. <p> If the PQ tried to make a larger copy of itself when
	 * increasing its size, it had a memory leak. Especially in the makeOpenMarketOpeation()
	 * method. I made the program wait a certain amount of time to overcome this issiue.
	 * 
